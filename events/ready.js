    ...
    async execute(client, commands){
        ...
        var members = await guild.members.fetch()
            ...
            members.forEach((member) => {
                ...
                channels.forEach((channel) => {if(channel.name === channelNumber) channel.permissionOverwrites.set([{id: member.user.id, allow: ["VIEW_CHANNEL"]}, {id: config.everyoneID, deny: ["VIEW_CHANNEL"]}])})
            })
